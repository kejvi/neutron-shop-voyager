    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-5 col-md-4 login-sidebar">
            ...
            <div class="login-container">
                ...
                <form action="{{ route('voyager.custom.login') }}" method="POST">
                    {{ csrf_field() }}
                    <div class="form-group form-group-default" id="emailGroup">
                        <label>{{ __('voyager::generic.email') }}</label>
                        <div class="controls">
                            <input type="text" name="username" id="email" value="{{ old('username') }}" placeholder="{{ __('voyager::generic.email') }}" class="form-control" required>
                        </div>
                    </div>
