...
return [
    ...
    'dashboard' => [
        ...
        'navbar_items' => [
            'Profile' => [
                ...
                'permission' => 'browse_profile',
            ],
            'ChangePassword' => [
                'route'      => 'voyager.change_password',
                'classes'    => 'class-full-of-rum',
    ...
    */
    ...
    'additional_js' => [
        ...
        'vendor/jQuery-printPage-plugin-master/jquery.printPage.js',
        'vendor/jQuery.countdown-master/dist/jquery.countdown.js',
    ],
